...
func _ready():
	...
	hide_textbox()
	queue_text("Essa é a nossa pista de skate! Seja bem-vindo! Nela, a cada segundo que passa o desafio aumenta! Tente pular os muros e desviar dos pássaros para juntar mais pontos! ")
